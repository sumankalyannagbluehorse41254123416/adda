...
async function getRooms(): Promise<Section[]> {
  ...
  return res.pageItemdataWithSubsection.sort(
  ...
  return (
    <>
      ...
      <section className="room_wrap">
        <div className="container">
          {rooms.map((room) => {
            const price = room.subsections?.[0]?.title;
            const icons = ROOM_ICONS[room.title] || [];

            return (
              <div className="room_item" key={room.id}>
                <div className="row">
                  <div className="col-lg-9 col-12">
                    <div className="r_left">
                      <Image
                      ...
                      <div className="ritem_det">
                        <span className="rname">{room.title}</span>

                        <div
                          dangerouslySetInnerHTML={{
                            __html: room.shortDescription as any,
                          }}
                        />
